...
public class RealRoomSourceServiceTest{
	
	protected Logger logger = LoggerFactory.getLogger(RealRoomSourceServiceTest.class);
    ...
    public void testAdd(){
        //todo test code
		RealRoomSourceVO vo = new RealRoomSourceVO();

		ResultDto resultDto = restTemplate.postForEntity("/realRoomSource/add",vo, ResultDto.class).getBody();
	...
	public void testUpdate(){
		//todo test code
		RealRoomSourceVO vo = new RealRoomSourceVO();
		ResultDto resultDto = restTemplate.postForEntity("/realRoomSource/update",vo, ResultDto.class).getBody();
		System.out.println(JSON.toJSONString(resultDto));
	}
	...
	public void testDelete(){
		//todo test code
		long id = 1L;
		ResultDto resultDto = restTemplate.postForEntity("/realRoomSource/delete",id, ResultDto.class).getBody();
		System.out.println(JSON.toJSONString(resultDto));
	}
	...
	public void testGetById(){
		//todo test code
		ResultDataDto resultDataDto = restTemplate.getForEntity("/realRoomSource/get?id=1",ResultDataDto.class).getBody();
