...
@Rollback
@Transactional
public class ClassFacadeTest extends AbstractTransactionalJUnit4SpringContextTests{
	
	protected Logger logger = LoggerFactory.getLogger(ClassFacadeTest.class);
