...
@Rollback
@Transactional
public class TeacherFacadeTest extends AbstractTransactionalJUnit4SpringContextTests{
	
	protected Logger logger = LoggerFactory.getLogger(TeacherFacadeTest.class);
