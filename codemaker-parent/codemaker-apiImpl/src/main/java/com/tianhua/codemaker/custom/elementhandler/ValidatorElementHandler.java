 ...
 *
 */
@Component(value = "validatorElementHandler")
@ElementTag(elementName = "validator")
public class ValidatorElementHandler implements DomainElementHandler<CustomElementBean> {
