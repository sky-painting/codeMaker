...
public class MethodBean {
     ...
     */
    private List<InvokeRowBean> invokeRowBeanList = new ArrayList<>();
    ...
    public List<String> getParamAnnotationList() {
        return paramAnnotationList;
    }

    public void setParamAnnotationList(List<String> paramAnnotationList) {
