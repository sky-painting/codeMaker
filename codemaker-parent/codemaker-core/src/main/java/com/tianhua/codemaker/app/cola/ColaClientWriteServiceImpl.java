...
public class ColaClientWriteServiceImpl extends WriteService implements IWriteFileService {
    ...
    private static final String moduleCode = "client";

    @Override
    public void writeContent(WriteContentBean writeContentBean) {
        ClassContentBean classContentBean = writeContentBean.buildClassContentBean(moduleCode, projectTemplateColaConfig.getModuleClientPath());
