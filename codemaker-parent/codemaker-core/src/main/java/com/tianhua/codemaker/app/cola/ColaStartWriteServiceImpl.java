...
public class ColaStartWriteServiceImpl extends WriteService implements IWriteFileService {
    ...
    private static final String moduleCode = "start";

    @Override
    public void writeContent(WriteContentBean writeContentBean) {
        ClassContentBean classContentBean = writeContentBean.buildClassContentBean(moduleCode, projectTemplateColaConfig.getModuleStartPath());
