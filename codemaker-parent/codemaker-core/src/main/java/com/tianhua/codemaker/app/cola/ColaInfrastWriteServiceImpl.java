...
public class ColaInfrastWriteServiceImpl extends WriteService implements IWriteFileService {
    ...
    private static final String moduleCode = "infrast";


    @Override
    public void writeContent(WriteContentBean writeContentBean) {
        ClassContentBean classContentBean = writeContentBean.buildClassContentBean(moduleCode, projectTemplateColaConfig.getModuleInfrastPath());
