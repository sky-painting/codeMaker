...
public class DubboCommonWriteServiceImpl extends WriteService implements IWriteFileService {
    ...
    private static final String moduleCode = "common";

    @Override
    public void writeContent(WriteContentBean writeContentBean) {
        ClassContentBean classContentBean = writeContentBean.buildClassContentBean(moduleCode, projectTemplateDubboConfig.getModuleCommonPath());
