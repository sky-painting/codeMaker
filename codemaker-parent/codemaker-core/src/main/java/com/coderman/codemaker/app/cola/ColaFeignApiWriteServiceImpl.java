...
public class ColaFeignApiWriteServiceImpl extends WriteService implements IWriteFileService {
    ...
    public void writeContent(WriteContentBean writeContentBean) {
        ClassContentBean classContentBean = writeContentBean.buildClassContentBean(projectTemplateColaConfig.getModuleFeignApiPath());
        //写api.dto-ddd
    ...
    private String getFilePath(String childPackageName, String humpClassName, String classSuffix) {
        ...
        return projectTemplateColaConfig.getModuleFeignApiPath()  + packagePath + "/" + fileName;
    }
}
