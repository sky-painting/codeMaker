...
public class SCFeignApiWriteServiceImpl  extends WriteService implements IWriteFileService {
    ...
    public void writeContent(WriteContentBean writeContentBean) {
        ClassContentBean classContentBean = writeContentBean.buildClassContentBean(projectTemplateSpringCloudConfig.getModuleFeginApiPath());
        //写api.dto-ddd
        ...
        //写feign
        if(writeContentBean.getTemplateName().equals(TemplateFileEnum.FEIGN.getTempFileName())){
            classContentBean.setHumpClassName(writeContentBean.getHumpClassName().toLowerCase().endsWith("feign") ? writeContentBean.getHumpClassName() : writeContentBean.getHumpClassName()+"Feign");
            classContentBean.setChildPackageName("api.feign");
            classContentBean.setClassSuffix("Feign.java");
    ...
    private String getFilePath(String childPackageName, String humpClassName, String classSuffix) {
        ...
        return projectTemplateSpringCloudConfig.getModuleFeginApiPath()  + packagePath + "/" + fileName;
    }
}
