...
public class WriteDynamicCodeService {
     ...
     * @param classBeanList
     */
    public void writeDomainRepository(List<InterfaceBean> classBeanList) {
        IWriteFileService writeFileService = appServiceConfig.getModuleWriteService(TemplateFileEnum.GATAWAY.getTempFileName());
        if (writeFileService == null) {
            return;
        }
        writeDynamicDDDModuleService.writeRepository(classBeanList,writeFileService,null);
    }
     ...
     * @param classBeanList
     */
    public void writeCache(List<ClassBean> classBeanList) {
        IWriteFileService writeFileService = appServiceConfig.getModuleWriteService(TemplateFileEnum.CACHE.getTempFileName());
        if (writeFileService == null) {
            return;
        }
        writeDynamicDDDModuleService.writeCache(classBeanList,writeFileService,null);
    }
     ...
     * @param doboConvertBeanList
     */
    public void writeDTO2DTOConvert(List<InterfaceBean> doboConvertBeanList) {
        IWriteFileService writeFileService = appServiceConfig.getModuleWriteService(TemplateFileEnum.DOBO_CONVERT.getTempFileName());
        if (writeFileService == null) {
            return;
        }
        writeDynamicDDDModuleService.writeDTO2DTOConvert(doboConvertBeanList,writeFileService);
    }
     ...
     * @param classBeanList
     */
    public void writeFeign(List<InterfaceBean> classBeanList) {
        IWriteFileService writeFileService = appServiceConfig.getModuleWriteService(TemplateFileEnum.FEIGN.getTempFileName());
        if (writeFileService == null) {
            return;
        }
        writeDynamicDDDModuleService.writeFeign(classBeanList,writeFileService);
    }
    ...
    public void writeAllWithDDD(Map<String,Object> allMetaDataMap){
        ...
        this.writeDomainRepository(repositoryBeanList);
        ...
        List<ClassBean> cacheBeanList = (List<ClassBean>)allMetaDataMap.get("cache");
        this.writeCache(cacheBeanList);

        List<ClassBean> voClassBeanList = (List<ClassBean>)allMetaDataMap.get("adaptervo");
        this.writeVO(voClassBeanList);

        List<ClassBean> controllerBeanList = (List<ClassBean>)allMetaDataMap.get("controller");
        this.writeController(controllerBeanList);


        List<InterfaceBean> derivefeignInterfaceBeanList = (List<InterfaceBean>)allMetaDataMap.get("derivefeign");
        this.writeFeign(derivefeignInterfaceBeanList);
        ...
        List<InterfaceBean> dto2dtoConvertInterfaceList = (List<InterfaceBean>)allMetaDataMap.get("convertdto2dto");

        this.writeFeignDTO(dtoClassBeanList);
        this.writeDTO2DTOConvert(dto2dtoConvertInterfaceList);
        ...
        if(appServiceConfig.getApiDocGenerator()){
            this.writeHttpApiDoc(controllerBeanList,voClassBeanList);
            this.writeRpcApiDoc(derivefacadeInterfaceBeanList,dtoClassBeanList);
            this.writeRpcApiDoc(derivefeignInterfaceBeanList,dtoClassBeanList);
