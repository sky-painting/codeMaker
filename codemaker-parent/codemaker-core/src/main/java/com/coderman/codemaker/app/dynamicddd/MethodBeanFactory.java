...
public class MethodBeanFactory {
    ...
    private List<String> vos2bosList = Lists.newArrayList("VOs2BOs", "voList2boList", "volist2boList", "voList2BoList","vos2bos");

    private List<String> bos2vosList = Lists.newArrayList("BOs2VOs", "boList2voList", "bolist2voList", "boList2VoList","bos2vos");
    ...
    public String getvolist2boListMethod(int index){
        ...
        return vos2bosList.get(Math.abs(random.nextInt(vos2bosList.size())));
    }
